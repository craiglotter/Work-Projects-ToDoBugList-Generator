...
Public Class Main_Screen
    ...
    Private Sub backgroundWorker1_RunWorkerCompleted(ByVal sender As Object, ByVal e As RunWorkerCompletedEventArgs) Handles BackgroundWorker1.RunWorkerCompleted
        ...
        Else
            ...
            If AlertMessage.Length > 0 Then
                ...
                MsgBox(AlertMessage & " copies of To Do List.txt and Bug List.txt were generated.", MsgBoxStyle.Information, "Operation Complete")
            End If
        End If
            ...
            If dinfo.Exists Then
                For Each subdir As DirectoryInfo In dinfo.GetDirectories
                    ...
                    If worker.CancellationPending Then
                        ...
                        Return False
                    End If
                    If My.Computer.FileSystem.FileExists((subdir.FullName & "\To Do List.txt").Replace("\\", "\")) = False Then
                        Dim writer As StreamWriter = New StreamWriter((subdir.FullName & "\To Do List.txt").Replace("\\", "\"), True)
                        writer.Write("")
                        writer.Close()
                        writer.Dispose()
                        writer = Nothing
                    ...
                    End If
                    If My.Computer.FileSystem.FileExists((subdir.FullName & "\Bug List.txt").Replace("\\", "\")) = False Then
                        Dim writer As StreamWriter = New StreamWriter((subdir.FullName & "\Bug List.txt").Replace("\\", "\"), True)
                        writer.Write("")
                        writer.Close()
                        writer.Dispose()
                        writer = Nothing
                    ...
                    inputlines = inputlines + 1
                    lastinputline = "Processed: " & (subdir.Name).Replace("\\", "\")
                    ' Report progress as a percentage of the total task.
                    percentComplete = 0
                    If inputlinesprecount > 0 Then
                        percentComplete = CSng(inputlines) / CSng(inputlinesprecount) * 100
    ...
    Private Sub Form1_Close(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Try
            ...
            If AutoUpdate = True Then
                ...
                End If
            End If
            Me.ToolStripStatusLabel1.Text = "Application Shutting Down"
        Catch ex As Exception
    ...
    Private Sub AutoUpdateToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AutoUpdateToolStripMenuItem.Click
        Try
            Me.ToolStripStatusLabel1.Text = "AutoUpdate Requested"
            AutoUpdate = True
            Me.Close()
        Catch ex As Exception
